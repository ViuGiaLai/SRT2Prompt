  ...
  return (
    <button
      className={cn(
        ...
        variant === "secondary" && "border-line bg-panelSoft text-fg hover:border-accent",
        variant === "ghost" && "border-transparent bg-transparent text-muted hover:bg-panelSoft hover:text-fg",
        variant === "success" && "border-success bg-success text-fg hover:bg-green-400",
