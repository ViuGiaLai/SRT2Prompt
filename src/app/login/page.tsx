        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <form className="mt-6 space-y-4" onSubmit={submit}>
            ...
            <label className="block">
              ...
              <input className="h-11 w-full rounded-md border border-line bg-panelSoft px-3 text-sm focus-ring" type="password" autoComplete="current-password" value={password} onChange={(event) => setPassword(event.target.value)} required />
            </label>
            ...
            <a href="/api/auth/google" className="flex h-11 w-full items-center justify-center gap-2 rounded-md border border-line bg-panelSoft text-sm text-fg hover:border-accent">
          ...
          <div className="mt-5 flex items-center justify-between text-sm">
            <Link href="/register" className="text-muted hover:text-fg">Create account</Link>
