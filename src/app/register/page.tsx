        ...
        <div className="rounded-lg border border-line bg-panel p-6">
          ...
          <form className="mt-6 space-y-4" onSubmit={submit}>
            ...
            <label className="block">
              ...
              <input className="h-11 w-full rounded-md border border-line bg-panelSoft px-3 text-sm focus-ring" type="password" autoComplete="new-password" value={password} onChange={(event) => setPassword(event.target.value)} required minLength={6} />
            </label>
